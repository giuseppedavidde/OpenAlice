...
export type ViewSpec =
  ...
  | { kind: 'settings';       params: { category: 'general' | 'appearance' | 'pet' | 'activity-bar' | 'ai-provider' | 'workspace-injection' | 'agent-runtimes' | 'agent-permissions' | 'tools' | 'trading' | 'issues' | 'harness' | 'connectors' | 'mcp' | 'market-data' | 'news-collector' | 'beta' } }
